...
>
> **Scope:** Template repo `workflow-orchestration-queue-tango48` only. Issues targeting generated code (sentinel, notifier, queue) are deferred to the implementation phase.
